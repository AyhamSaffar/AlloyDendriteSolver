...
std::tuple<double, double> dummyModel(double V, double R, double dT, double C0, const alloys::Alloy& A)
{
...
{
    double V{3.0}, R{5.0};
    diff::Jacobian J{diff::calculateGrads<dummyModel>(V, R, 1.0, 1.0, alloys::SnAg_wtp)};
