...
int main()
{
    ...
    const alloys::LGKAlloy A{alloys::SnAg_wtp}; // common solder material, with concentrations in wt.%
    ...
    for (int step{0}; step<100; ++step)
    {
        ...
        J = diff::calculateGrads<models::LGK<alloys::LGKAlloy>, alloys::LGKAlloy>(V, R, dT, C0, A);
